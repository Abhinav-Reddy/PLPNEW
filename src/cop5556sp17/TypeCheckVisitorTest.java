...
public class TypeCheckVisitorTest {
    ...
    public void testSleepStatement() throws Exception {
        ...
        assertEquals(Type.TypeName.INTEGER, expression.getType());
    }
...
//        thrown.expect(TypeCheckVisitor.TypeCheckException.class);
    ...
    public void testIdentChain() throws Exception {
        ...
        assertEquals(Type.TypeName.BOOLEAN, e1.getType());
    }
    ...
    public void testFilterOpChain() throws Exception {
        ...
        assertEquals(Type.TypeName.IMAGE, e0.getType());
        assertEquals(Type.TypeName.IMAGE, e1.getType());
    }
    ...
    public void testBinaryChain2() throws Exception {
        ...
        assertEquals(Type.TypeName.FRAME, binaryChain.getType());
    }
    ...
    public void testBinaryChain3() throws Exception {
        ...
        assertEquals(Type.TypeName.NONE, binaryChain.getType());
    }
    ...
    public void testBinaryChain5() throws Exception {
        ...
        for (String input : inputList) {
            ...
            assertEquals(Type.TypeName.INTEGER, binaryChain.getType());
        }
    }
    ...
    public void testWhileStatement0() throws Exception {
        ...
        assertEquals(Type.TypeName.BOOLEAN, expression.getType());
    }
    ...
    public void testIdentExpression() throws Exception {
        ...
        TypeCheckVisitor typeCheckVisitor = new TypeCheckVisitor();
        program.visit(typeCheckVisitor, null);
        assertEquals(Type.TypeName.INTEGER, identExpression.getType());
        //assertEquals(decs.get(0), identExpression.dec);
    }
    ...
    public void testIntLitExpression() throws Exception {
        ...
        assertEquals(Type.TypeName.INTEGER, intLitExpression.getType());
    }
    ...
    public void testBooleanLitExpression0() throws Exception {
        ...
        assertEquals(Type.TypeName.BOOLEAN, booleanLitExpression.getType());
    }
    ...
    public void testConstantExpression0() throws Exception {
        ...
        assertEquals(Type.TypeName.INTEGER, constantExpression.getType());
    }
    ...
    public void testBinaryExpr0() throws Exception {
        ...
        assertEquals(Type.TypeName.INTEGER, binaryExpression.getType());
    }
    ...
    public void testBinaryExpr1() throws Exception {
        ...
        assertEquals(Type.TypeName.IMAGE, binaryExpression.getType());
    }
    ...
    public void testBinaryExpr5() throws Exception {
        ...
        for (String input : inputList) {
            ...
            assertEquals(Type.TypeName.BOOLEAN, binaryExpression.getType());
        }
    }
    ...
    public void testImageOpChain1() throws Exception {
        ...
        assertEquals(Type.TypeName.IMAGE, imageOpChain0.getType());
        assertEquals(Type.TypeName.INTEGER, imageOpChain1.getType());
